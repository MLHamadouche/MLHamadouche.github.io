...
*PhD in Astronomy*  
**Thesis title:** *Constraining quenching mechanisms at high redshift:
the sizes, masses & star-formation histories of massive galaxies*,
supervised by Prof. Ross McLure  
...
(in prep. soon to be submitted to A&A)

K. Ito, F. Valentino, G. Brammer, **M. L. Hamadouche**, K. Whitaker et
al. *DeepDive:A deep dive into the physics of the first massive
quiescent galaxies in the Universe.* Submitted to A&A, arXiv:2506.22642.
...
combined VANDELS and LEGA-C study: the evolution of quiescent galaxy
size, stellar mass and age from z = 0.6 to z = 1.3*. MNRAS, Mar. 2022,
...
Baltimore, MD* *2025*  
**Quenching Review Talk (*invited*)** *Choir Conference, Schoodic
Institute, Acadia, ME* *2025*  
**Big Galaxies, Big Problems (*invited*)** *Lorentz Center, Leiden,
Netherlands* *2025*  
**Beyond the Edge of the Universe** *Instituto de Astrofísica e Ciências
do Espaço, Portugal* *2024*  
**FCAD Colloquium (*invited*)** *Department of Astronomy, UMass Amherst,
MA* *2024*  
**National Astronomy Meeting** *Cardiff, Wales, UK* *2023*  
**Durham-Edinburgh EXtragalactic Meeting** *Durham, UK* *2023*  
**Rise & Fall of SF Symposium** *International Astronomical Union,
...
*Dynamics & Vector Calculus*, Second Year Pre-Honours *2022 - 2023*  
*Observational Astronomy*, Junior Honours *2020 - 2022*  
*Introductory Astrophysics Problem-Solving Workshops*, First Year
Pre-Honours *2020 - 2023*  
...
|  |  |  |
|:---|:---|:---|
| **Professional Development Fund** *(UMass Amherst)* | *$ 791* | *2025* |
| **Best PhD Thesis in Astronomy Prize** *(University of Edinburgh)* | *£500* | *2024* |
| **Travel Bursary** *(International Astronomical Union)* | * 2,000* | *2022* |
...
*Lead investigator for star-formation histories & chemical abundances of
quiescent galaxies at 3 \< *z* \< 4*

**Classifying LRDs in the distant Universe** PI: Barrufet  
*Lead investigator for morphologies of LRDs at *z* ∼ 6*

***JWST* EXCELS** ‘The early extragalactic continuum and emission line
survey’, PIs: Carnall, Cullen  
***JWST* PRIMER** ‘Public Release Imaging for Extragalactic Research’,
PI: Dunlop  
...
**Volunteer** *Granby Library Star-gazing Night* Public star-gazing
event at Granby Library, MA *2025*  
**Volunteer** *Eureka! 2-day Workshop* “A Cosmic Photoshoot to ImPress”,
STEM event for middle schoolers from local underserved communities
*2025*  
**Public Talk** *Astronomy on Tap, Western Mass.* ‘Massive, red & dead
... or not? The not-so-permanent deaths of massive galaxies’ *2025*  
...
|  |  |
|:---|---:|
| **Programming languages/tools** | Python, Pandas, Numpy, LaTeX, Matplotlib, Slurm, SED fitting |
